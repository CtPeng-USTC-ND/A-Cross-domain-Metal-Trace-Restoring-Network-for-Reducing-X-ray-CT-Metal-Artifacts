...
from .._ext import sin_conv

class SinConvFunction(Function):
    def __init__(self, out_height, out_width):
        super(SinConvFunction, self).__init__()
...
#         self.save_for_backward(input)
        ...
        if not input.is_cuda:
            ...
            sin_conv.sin_conv_forward_cuda(
                input, output)
        return output
...
#         input = self.saved_tensors[0]
        ...
        if not grad_output.is_cuda:
            ...
            if self.needs_input_grad[0]:
                ...
                sin_conv.sin_conv_backward_input_cuda(grad_output, grad_input)
